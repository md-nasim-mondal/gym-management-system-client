  ...
  return (
    <footer className='bg-gray-900 text-white py-12 w-full'>
      <div className='container mx-auto px-4  w-full md:max-w-[90%]'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8 md:items-center justify-center md:justify-between'>
          ...
          {links.map((section, index) => (
            <div key={index} className="md:ml-auto flex flex-col items-center md:items-start">
